...
SRCS = ./ft_reconflags.c ./ft_currentdir.c ./ft_aflag.c\
	   ./ft_verflag.c ./ft_isdir.c ./ft_otherdir.c\
	   ./ft_check_flags.c ./ft_lflag.c ./ft_out_of_scope.c ./ft_check_multi.c\
	   ./ft_get_time.c ./ft_getgid.c ./ft_aotherdir.c ./ft_getuid.c\
	   ./da_perm.c ./ft_rflag.c ./ft_bubblesort.c ./ft_crflag.c ./ft_tflag.c\
	   #./ft_crflag.c ./ft_conflags.c\ 
	   #./get_owner.c ./ft_sort.c\
